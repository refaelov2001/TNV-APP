...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-[16px] border border-[var(--color-border-strong)] bg-[var(--color-bg-surface)] p-6 shadow-2xl animate-fade-up",
        className
      )}
      {...props}
    >
